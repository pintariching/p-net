...
static int app_connect_ind (
     ...
     *  This is a very simple application which does not need to handle
     * anything. All the needed information is in the AR data structure.
     */
...
//                  p_subslot->submodule_id ==
//                  APP_GSDML_SUBMOD_ID_DIGITAL_IN_OUT))
//             {
...
//         if (app->alarm_allowed == true && app_is_connected_to_controller
//         (app))
//         {
//             app->alarm_payload[0]++;
//             APP_LOG_INFO (
...
//         APP_LOG_INFO (
//             "Setting cyclic data to backup and to redundant. See
//             Wireshark.\n");
//         if (pnet_set_primary_state (app->net, false) != 0)
//         {
//             APP_LOG_WARNING ("   Could not set cyclic data state to
//             backup.\n");
//         }
//         if (pnet_set_redundancy_state (app->net, true) != 0)
//         {
//             APP_LOG_WARNING (
//                 "   Could not set cyclic data state to redundant.\n");
//         }
//         break;
...
//         {
//             APP_LOG_ERROR ("   Could not set cyclic data state to
//             primary.\n");
//         }
...
//         {
//             APP_LOG_INFO (
//                 "Writing to logbook. Error_code1: %02X Error_code2: %02X  "
//                 "Entry "
//                 "detail: 0x%08X\n",
...
//         {
//             APP_LOG_WARNING (
//                 "Could not add logbook entry as no connection is
//                 available\n");
//         }
//         break;
